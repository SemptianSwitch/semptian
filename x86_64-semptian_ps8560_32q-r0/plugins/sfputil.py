...
class SfpUtil(SfpUtilBase):
    ...
    def __init__(self):
        ...
        for x in range(0, self.port_end+1):
            i2c_index = (self._port_to_i2c_offset[x]+7)
            self.port_to_eeprom_mapping[x] = eeprom_path.format(i2c_index)            
    ...
    def _get_eeprom_path(self, port_num):
        ...
        eeprom_path = self.BASE_OOM_PATH + "eeprom" 
        port_index = self._port_to_i2c_offset[port_num] + SFP_I2C_START
    ...
    def get_presence(self, port_num):
        ...
        #print("sfputil get_presence---traceback----port_num:%d------------------ " % port_num) 
